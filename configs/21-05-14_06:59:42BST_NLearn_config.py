...
hyperparameters = {  #TODO enable dictionary-based choices for finer choosing
    ...
    'ALICE_NET': [
        #'MaxNet("In", 3, 50,  bias_included=True, beta=1.0, relu=True)',
        #'MaxNet("In", 3, 50,  bias_included=True, beta=1.0, relu=False)',
        'MaxNet("In", 3, 50,  bias_included=True, beta=0.6, relu=True)',
        'MaxNet("In", 3, 50,  bias_included=True, beta=0.6, relu=False)',
        'MaxNet("In", 3, 50, beta=1.0, relu=True)',
        'MaxNet("In", 3, 50, beta=1.0, relu=False)',
        'MaxNet("In", 3, 50, beta=0.6, relu=True)',
        'MaxNet("In", 3, 50, beta=0.6, relu=False)'
    ],  # 'FFs(3, 50)',
    'BOB_NET': 'FFs(3, 50)',
    'BATCHSIZE': 32,
    'GAMESIZE': 32,
