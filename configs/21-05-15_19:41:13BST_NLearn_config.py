...
hyperparameters = {  #TODO enable dictionary-based choices for finer choosing
    'N_ITERATIONS': 70 * (10 ** 3) // divisor,   # 5 * (10 ** 5),
    'RANDOM_SEEDS': [
    ...
    'BATCHSIZE': 32,
    'GAMESIZE': 32,
    'BUFFER_CAPACITY': 32 * 20000 // divisor,
    'START_TRAINING': 20000 // divisor,
    'N_SELECT': 256,  # 256,  #16,
    'EPSILON_ONE_END': 2000 // divisor,  #25000,  # 40000,
    'EPSILON_MIN': 0.0,
    'EPSILON_MIN_POINT': 20000 // divisor,  #3 * (10 ** 5),
    'ALICE_PLAY': 'QPerCode',
...
"""
SMOOTHING_LENGTH = 10000 // divisor
SAVE_PERIOD = 10 ** 5   # Also saves on the last iteration
CODE_BOOK_PERIOD = 10000 // divisor
