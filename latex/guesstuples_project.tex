...
\begin{enumerate}
	...
	\item If increase \verb|N_SELECT| to $16$ (all the numbers shown to Bob), then, in run \verb|21-05-03_10:53:10|, gets to $\verb|reward|=0.8,$ as good as for $\verb|N_SELECT|=5.$  Alice's code book is still very small:
	\begin{lstlisting}
